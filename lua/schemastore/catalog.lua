...
M.json = {
  ...
  index = {
    ...
    [".mtaext"] = 1089,
    [".nodehawkrc"] = 701,
    [".npmpackagejsonlintrc"] = 706,
    [".omletrc"] = 1270,
    [".phrase.yml"] = 788,
    [".phraseapp.yml"] = 789,
    [".pmbot.yml"] = 773,
    [".postcssrc"] = 782,
    [".powerpages-web-template-manifest"] = 784,
    [".pre-commit-config.yml"] = 785,
    [".pre-commit-hooks.yml"] = 786,
    [".putout.json"] = 822,
    [".rehyperc"] = 847,
    [".remarkrc"] = 851,
    [".sprite files"] = 953,
    ...
    [".vsconfig"] = 1050,
    [".vsext"] = 1051,
    ["1Password SSH Agent Config"] = 16,
    ["@factorial/drupal-breakpoints-css"] = 25,
    ["A micro editor config"] = 637,
    ABCClinicalDemandForecast = 35,
    ABCInventoryModuleData = 34,
    ABCSupplyPlan = 36,
    ["ACP Attempts"] = 37,
    ["ACP Cache File"] = 38,
    ["ACP Configuration File"] = 39,
    ["ACP Primer"] = 40,
    ["ACP Sync"] = 41,
    ["ACP Variables File"] = 42,
    ["AI Harness config"] = 44,
    ["AI Harness org policy"] = 45,
    AIConfig = 46,
    ["AMX Muse Program Descriptor"] = 1319,
    ["API Builder"] = 1125,
    ["AVA Configuration"] = 1189,
    ["AWS AppConfig Feature Flags-v1"] = 85,
    ["AWS CDK cdk.json"] = 314,
    ["AWS CloudFormation"] = 315,
    ["AWS CloudFormation Serverless Application Model (SAM)"] = 316,
    ["AWS Copilot Manifest"] = 1358,
    ["AWS SAM CLI Samconfig"] = 317,
    Acton = 1412,
    ["Adobe UXP Manifest"] = 1252,
    ["Aerleon Network & Service Definitions"] = 28,
    ["Aerleon Policy"] = 29,
    ["Agent Permission Policy"] = 1398,
    ["AgentCore CLI"] = 1399,
    ["AgentCtl MCP"] = 1401,
    ["AgentCtl config"] = 1400,
    ["AgentCtl permissions"] = 1402,
    AgentLoopKit = 1403,
    Aider = 1348,
    Air = 31,
    ["Airbyte Connector Metadata Specification (metadata.yaml)"] = 1369,
    ["Airbyte Declarative Connectors Specification (manifest.yaml)"] = 1368,
    ["Airlock Microgateway"] = 47,
    ["Alacritty Configuration"] = 1161,
    ["AlgoVoi Compliance Receipt v1"] = 17,
    ["All Contributors configuration file"] = 1215,
    ["Amazon S3 bucket CORS"] = 19,
    Anodizer = 513,
    ["Ansible Argument Specs"] = 495,
    ["Ansible Collection Galaxy"] = 502,
    ["Ansible Execution Environment"] = 492,
    ["Ansible Inventory"] = 501,
    ["Ansible Meta"] = 493,
    ["Ansible Meta Runtime"] = 494,
    ["Ansible Navigator Configuration"] = 504,
    ["Ansible Playbook"] = 499,
    ["Ansible Requirements"] = 496,
    ["Ansible Rulebook"] = 500,
    ["Ansible Tasks File"] = 498,
    ["Ansible Vars File"] = 497,
    ["Ansible-lint Configuration"] = 503,
    Any = 1280,
    ["AnyWork Automation Configuration"] = 24,
    ["Apollo Router"] = 1126,
    ["App config Spotify Backstage"] = 51,
    ["Applicant Profile Protocol"] = 21,
    ["Application Accelerator"] = 18,
    ["Application list for a WinUtil"] = 1298,
    ["ArchSmith diagram IR"] = 1437,
    ArchitectFX = 1303,
    ["Archival editor configuration"] = 66,
    ["Archival object definitions"] = 67,
    ["Archival site configuration"] = 68,
    ["Archival template definition"] = 69,
    ["Are The Types Wrong?"] = 74,
    ["Argo CD"] = 70,
    ["Argo Events"] = 71,
    ["Argo Workflows"] = 72,
    AssemblyScript = 76,
    AsyncAPI = 79,
    ["AsyncAPI Tool File"] = 80,
    ["Atmos Manifests"] = 81,
    ["Aurora Agile Meta-Framework"] = 82,
    AutoAPICase = 1225,
    ["Avro Avsc"] = 83,
    ["Awesome Repositories"] = 84,
    ["Azure Container App template for defining an immutable revision"] = 87,
    ["Azure DevOps extension manifest"] = 90,
    ["Azure Device Update for IoT Hub import manifest"] = 88,
    ["Azure Device Update for IoT Hub update manifest"] = 89,
    ["Azure IoT Edge deployment"] = 93,
    ["Azure IoT Edge deployment template"] = 94,
    ["Azure IoT EdgeAgent deployment"] = 91,
    ["Azure IoT EdgeHub deployment"] = 92,
    ["Azure IoT Operations Wasm Graph Config"] = 1367,
    ["Azure IoT Operations connector metadata"] = 1364,
    ["Azure Landing Zones Library archetype definition"] = 98,
    ["Azure Landing Zones Library archetype override"] = 99,
    ["Azure Landing Zones Library architecture definition"] = 97,
    ["Azure Landing Zones Library metadata"] = 95,
    ["Azure Landing Zones Library policy default values"] = 96,
    ["Azure Pipelines"] = 134,
    ["Azure Static Web Apps CLI configuration file"] = 957,
    ["Azure Static Web Apps configuration file"] = 956,
    BMML = 1386,
    ["BOSH BPM Config"] = 160,
    ["BOSH CPI Config"] = 161,
    ["BOSH Deploy Config"] = 162,
    ["BOSH Job Spec"] = 163,
    ["BOSH Ops File"] = 165,
    ["BOSH Package Spec"] = 164,
    ["BX CI"] = 186,
    ["Bacon config"] = 11,
    ["Barba-CV"] = 100,
    ["Bashly (bashly.yml)"] = 1219,
    ["Bashly Settings (bashly-settings.yml)"] = 1220,
    Bento = 1385,
    ["Better Code Hub"] = 1130,
    ["Better Scripts"] = 187,
    Bigconfig = 153,
    ["Biome Formatter Config"] = 101,
    ["Bitmovin Encoding Template"] = 1312,
    BizTalkServerApplicationSchema = 1096,
    Bleep = 188,
    ["Block Protocol Metadata"] = 185,
    ["Bluebricks blueprint config"] = 1391,
    ["Boyka Framework"] = 166,
    ["Bpod Finite-State Machine"] = 103,
    Briefcase = 1102,
    ["Build Info"] = 176,
    Buildkite = 178,
    ["Bukkit plugin.yml"] = 177,
    ["BungeeCord plugin.yml"] = 183,
    ["Burnless SRE config"] = 4,
    ["Butane Config"] = 1174,
    C4InterFlow = 1327,
    ["CDK Environment Manager, concrete environment configuration"] = 1351,
    ["CDK Environment Manager, concrete environments definition"] = 1350,
    ["CDK Environment Manager, environment definition"] = 1349,
    ["CGS Card Game Specification (cgs.json)"] = 1257,
    ["CICS TS region tagging"] = 1183,
    ["CICS TS resource import"] = 1184,
    ["CICS TS resource model"] = 1185,
    ["CICS TS resource overrides"] = 1186,
    ["CMake Presets"] = 189,
    ["CNC Codes"] = 212,
    ["CRS WAF test file"] = 1287,
    ["CRS WAF test platform overrides file"] = 1288,
    ["CSS Comb (.csscomb.json)"] = 344,
    ["CSS Lint (.csslintrc)"] = 345,
    ["CSpell (cspell.json)"] = 343,
    ["CVE Record Format"] = 224,
    ["CVX achievements.yaml"] = 230,
    ["CVX competencies.yaml"] = 229,
    ["CVX config.yaml"] = 233,
    ["CVX education.yaml"] = 228,
    ["CVX experience.yaml"] = 227,
    ["CVX keywords.yaml"] = 232,
    ["CVX layout"] = 234,
    ["CVX personal.yaml"] = 225,
    ["CVX referees.yaml"] = 231,
    ["CVX summary.yaml"] = 226,
    CWL = 1263,
    ["Cache Warmup config"] = 190,
    ["Caido Proxy Configuration"] = 1427,
    ["Calqulus pipeline"] = 191,
    ["Camel YAML DSL"] = 192,
    ["Cannon TOML"] = 193,
    Carafe = 194,
    ["Cargo Make"] = 196,
    ["Cargo Manifest"] = 195,
    ["Catalog Info Backstage"] = 197,
    ["Chamaleon environment"] = 1316,
    ["Chamaleon properties"] = 1317,
    ["Chamaleon template"] = 1315,
    Changepacks = 1378,
    Changesets = 326,
    Changie = 198,
    Charmcraft = 199,
    Cheatsheets = 1171,
    ["ChordPro Configuration"] = 201,
    ["Chrome Extension"] = 307,
    ["Chromia Model"] = 202,
    ["Chromia Seeder Module Config"] = 204,
    ["Chromia Seeder Root Config"] = 203,
    ["Cinnamon Spice info.json"] = 111,
    ["CircleCI config.yml"] = 277,
    ["Citation File Format"] = 328,
    ["Citrus test case"] = 206,
    CityJSON = 207,
    ["Claude Code Keybindings"] = 219,
    ["Claude Code Launch Preview"] = 1436,
    ["Claude Code Plugin Manifest"] = 220,
    ["Claude Code Plugin Marketplace"] = 221,
    ["Claude Code Settings"] = 222,
    ["Clawject config"] = 218,
    ["Cloud Foundry Application Manifest"] = 1269,
    ["Cloud Run Spec v1"] = 1293,
    ["Cloud.gov Workshop Configuration"] = 112,
    ["CloudCannon Configuration"] = 117,
    ["CloudCannon Configuration (Collection Structures)"] = 126,
    ["CloudCannon Configuration (Collections)"] = 125,
    ["CloudCannon Configuration (Editables)"] = 124,
    ["CloudCannon Configuration (Inputs)"] = 119,
    ["CloudCannon Configuration (Snippets Definitions)"] = 123,
    ["CloudCannon Configuration (Snippets Imports)"] = 122,
    ["CloudCannon Configuration (Snippets)"] = 121,
    ["CloudCannon Configuration (Structure Value)"] = 120,
    ["CloudCannon Configuration (Structures)"] = 118,
    ["CloudEvents specification"] = 208,
    ["Code Climate"] = 278,
    CodeCV = 115,
    CodeRabbit = 114,
    ["CodeShip Pro services configuration files"] = 296,
    ["CodeShip Pro steps configuration files"] = 297,
    ["Codecov configuration files"] = 295,
    Codex = 286,
    ["Codex Hooks"] = 287,
    ["Codex Plugin Manifest"] = 288,
    ["Codex Skill Metadata"] = 289,
    CodifyCLI = 116,
    Codux = 291,
    ["Cog config file"] = 213,
    ["Commandbox Box.json"] = 214,
    ["Commandbox Server.json"] = 215,
    ["Common Catalog Data"] = 305,
    ["Common Package Specification"] = 216,
    Concord = 1286,
    ["Configu .cfgu files"] = 1274,
    ["Configu .configu file"] = 1275,
    Conjure = 211,
    ["Container Structure Test"] = 1110,
    Containerlab = 1139,
    ["Contextive Glossary"] = 1343,
    ContractGuard = 1140,
    Convex = 210,
    ["Crowdsec collection config"] = 337,
    ["Crowdsec parser config"] = 338,
    ["Crowdsec scenario config"] = 339,
    ["CumulusCI Config"] = 217,
    ["Cursor Agent Environment"] = 1396,
    ["Custom Machinery Machine"] = 1258,
    ["Custom Machinery Recipe"] = 1259,
    ["Cycle Stack File"] = 235,
    CycloneDX = 236,
    ["DWP Exchange - catalogue entry"] = 393,
    ["DWP Exchange - gateway"] = 391,
    ["DWP Exchange - meta"] = 392,
    ["Dagger module"] = 346,
    ["Dark Factory consumer config"] = 237,
    ["Dart Build Config (dart-build.json)"] = 347,
    ["Dart Test Config (dart-test.json)"] = 348,
    ["DashLord Configuration"] = 349,
    ["Data Contract Specification"] = 350,
    ["Data Product Specification"] = 351,
    ["DataYoga Connections"] = 238,
    ["DataYoga Job"] = 239,
    ["Datadog Continuous Testing"] = 602,
    ["Datadog Service Definition"] = 603,
    ["Datadog Software Catalog"] = 604,
    ["Datahub Ingestion Recipe"] = 1190,
    ["Debian Upstream Metadata file"] = 246,
    DebtLens = 247,
    ["Deck config"] = 248,
    ["Declarative Automation Bundles"] = 1236,
    ["DeepMatch deeplinks spec"] = 249,
    ["Dein Config"] = 250,
    ["Deno Config (deno.json)"] = 359,
    ["Dependency cruiser"] = 251,
    ["DeployStack Configuration"] = 252,
    ["Deployah Configuration"] = 1366,
    ["Deployer Recipe"] = 362,
    ["Design Tokens Community Group format"] = 253,
    ["Design Tokens Community Group resolver"] = 254,
    ["Deta Spacefile"] = 255,
    ["Detekt Config (detekt.yml)"] = 363,
    ["Devbox Config"] = 256,
    ["Devbox Plugin"] = 257,
    Devfile = 390,
    Devup = 1379,
    DipDup = 1289,
    ["Discord Webhook"] = 364,
    ["DocFx Config (docfx.json)"] = 369,
    ["Docker Desktop extension metadata"] = 366,
    ["Docs MCP Manifest"] = 370,
    Dofigen = 371,
    ["Dolittle Artifacts"] = 372,
    ["Dolittle Bounded Context Configuration"] = 373,
    ["Dolittle Event Horizons Configuration"] = 374,
    ["Dolittle Resources Configuration"] = 375,
    ["Dolittle Server Configuration"] = 376,
    ["Dolittle Tenant Map Configuration"] = 378,
    ["Dolittle Tenants Configuration"] = 377,
    ["Dolittle Topology"] = 379,
    ["DonateCaseBetterCasino menu"] = 1320,
    ["Draugr Saga"] = 357,
    ["Draugr Saga fragment"] = 358,
    ["Drupal Breakpoints"] = 259,
    ["Drupal Config"] = 271,
    ["Drupal Info"] = 260,
    ["Drupal Layouts"] = 261,
    ["Drupal Libraries"] = 262,
    ["Drupal Links Action"] = 263,
    ["Drupal Links Contextual"] = 264,
    ["Drupal Links Menu"] = 265,
    ["Drupal Links Task"] = 266,
    ["Drupal Migration"] = 267,
    ["Drupal Permissions"] = 268,
    ["Drupal Recipe"] = 269,
    ["Drupal Routing"] = 270,
    ["Drupal Services"] = 272,
    ["Drush site aliases"] = 385,
    ["Dust configuration"] = 388,
    ["Dynamic Bash Aliases (.aliases)"] = 1227,
    ["EAS config"] = 432,
    ["ECA - Editor Code Assistant"] = 395,
    ["ES6 Import Sorter (.es6importsorterrc.json)"] = 1216,
    ["ESLint Suppressions"] = 437,
    ["EUDR IOP Standard Exchange Format (EUDR-X)"] = 1363,
    ["EasyVCR .NET"] = 434,
    ["Eidolon Resource"] = 1304,
    ["Elgato Stream Deck"] = 398,
    Elm = 1291,
    ["Embrace Config"] = 1202,
    Emmet = 1292,
    Endurica = 1240,
    ["Enonic XP API descriptor"] = 401,
    ["Enonic XP Admin Extension descriptor"] = 402,
    ["Enonic XP Admin Tool descriptor"] = 403,
    ["Enonic XP Application descriptor"] = 404,
    ["Enonic XP CMS descriptor"] = 405,
    ["Enonic XP Content Type descriptor"] = 406,
    ["Enonic XP Form Fragment descriptor"] = 407,
    ["Enonic XP ID Provider descriptor"] = 408,
    ["Enonic XP Layout descriptor"] = 409,
    ["Enonic XP Macro descriptor"] = 410,
    ["Enonic XP Mixin descriptor"] = 411,
    ["Enonic XP Page descriptor"] = 412,
    ["Enonic XP Part descriptor"] = 413,
    ["Enonic XP Service descriptor"] = 414,
    ["Enonic XP Site descriptor"] = 415,
    ["Enonic XP Style descriptor"] = 416,
    ["Enonic XP Task descriptor"] = 417,
    ["Enonic XP Webapp descriptor"] = 418,
    ["Enterprise Contract Policy Spec"] = 399,
    ["Envelope Team Definition"] = 1411,
    ["Envilder Map File"] = 400,
    ["Erda Pipeline"] = 1265,
    ["Erda Runtime"] = 1266,
    ["Espanso config.yml"] = 1389,
    ["Espanso match.yml"] = 1388,
    Esquio = 420,
    ["Estuary Flow Catalog"] = 1180,
    ["Ethereum ERC1155"] = 1405,
    ["Ethereum ERC721"] = 1404,
    ["EveryVoice TTS Toolkit Aligner Configuration"] = 425,
    ["EveryVoice TTS Toolkit Data Configuration"] = 426,
    ["EveryVoice TTS Toolkit E2E Configuration"] = 430,
    ["EveryVoice TTS Toolkit Feature Prediction Configuration"] = 429,
    ["EveryVoice TTS Toolkit Text Configuration"] = 427,
    ["EveryVoice TTS Toolkit Vocoder Configuration"] = 428,
    ["Evolving Resolutive Process notation"] = 1365,
    ["Expo SDK"] = 431,
    ["Expoot app config"] = 433,
    ["F-Droid Data metadata"] = 439,
    ["FasterCI Configuration"] = 135,
    ["Fence configuration"] = 136,
    FiQuS = 443,
    Firebase = 441,
    ["Flatpak Builder Manifest"] = 444,
    ["FlexGet Config"] = 445,
    ["Flow.json Configurations"] = 1262,
    ["Fossa configuration file"] = 452,
    ["Fossa's fossa-deps file"] = 453,
    ["Foundry VTT - Base package Manifest"] = 447,
    ["Foundry VTT - Module Manifest"] = 448,
    ["Foundry VTT - System Data Template"] = 451,
    ["Foundry VTT - System Manifest"] = 449,
    ["Foundry VTT - World Manifest"] = 450,
    ["Foxx Manifest"] = 137,
    ["Freifunk.de Community API"] = 140,
    ["Frogbot Config"] = 141,
    ["G2P Mapping Configuration"] = 460,
    GAMA = 461,
    ["GCP Blueprint Metadata"] = 464,
    Gaspar = 462,
    ["GatewayCore API Gateway"] = 463,
    ["Gemini CLI settings"] = 465,
    ["GeoJSON.json latest"] = 1178,
    GherKing = 1182,
    ["GitHub Action"] = 475,
    ["GitHub Actions typing"] = 1300,
    ["GitHub CLI configuration"] = 476,
    ["GitHub CLI hosts"] = 477,
    ["GitHub Discussion"] = 478,
    ["GitHub Funding"] = 480,
    ["GitHub Issue Template configuration"] = 481,
    ["GitHub Issue Template forms"] = 482,
    ["GitHub Pages Jekyll"] = 483,
    ["GitHub Prompt"] = 479,
    ["GitHub Secret Scanning"] = 484,
    ["GitHub Workflow"] = 485,
    ["GitHub Workflow Template Properties"] = 486,
    ["GitHub automatically generated release notes configuration"] = 487,
    ["GitLab Agent for Kubernetes configuration"] = 1254,
    ["GitLab Duo Workflow"] = 489,
    GitResume = 491,
    GitVersion = 468,
    ["Gitea Issue Template configuration"] = 471,
    ["Gitea Issue Template forms"] = 472,
    Gitleaks = 469,
    ["Gitpod Configuration"] = 490,
    ["Glamour style"] = 466,
    ["GlazeWM settings"] = 1256,
    ["Global Privacy Control"] = 467,
    Goblet = 1235,
    ["Golangci-lint Configuration"] = 506,
    ["Golangci-lint Custom Plugins Configuration"] = 507,
    ["Google Chrome Related Website Sets"] = 442,
    ["Google Cloud Workflows"] = 313,
    ["Google Digital Assetlinks"] = 1344,
    Goreleaser = 511,
    ["Goreleaser Pro"] = 512,
    Goss = 514,
    ["Gradle Build Cache Node"] = 1128,
    ["Gradle Enterprise"] = 1127,
    ["Grafana 5.x Dashboard"] = 515,
    ["GraphQL Code Generator"] = 520,
    ["GraphQL Config"] = 519,
    ["GraphQL Mesh"] = 518,
    ["GroovyLint configuration"] = 521,
    ["Grunt JSHint task"] = 525,
    ["Grunt Watch task"] = 526,
    ["Grunt base task"] = 527,
    ["Grunt clean task"] = 523,
    ["Grunt copy task"] = 522,
    ["Grunt cssmin task"] = 524,
    HEMTT = 1092,
    Hadolint = 1106,
    Hammerkit = 1138,
    ["Hardware Sentry Configuration"] = 1194,
    ["Hashgraph Online Skill Manifest"] = 7,
    ["HashiCorp Vault"] = 528,
    Hatch = 1107,
    Hayson = 530,
    ["Haystack Pipeline"] = 531,
    ["Hazelcast 5 Configuration"] = 532,
    ["Hecate Input Schema"] = 1355,
    ["Helm Chart.lock"] = 274,
    ["Helm Chart.yaml"] = 273,
    ["Helm Unittest Test Suite"] = 275,
    ["Heloisa Assistant Plugins Marketplace"] = 1434,
    ["Hex file"] = 276,
    ["Home Assistant Integration Manifest"] = 534,
    ["Homer dashboard configuration"] = 535,
    ["Hoverfly Simulation"] = 540,
    Hugo = 1170,
    ["Hugo Theme"] = 1169,
    ["Hulak Configuration"] = 543,
    ["Hyperfoil benchmark configuration"] = 542,
    ["IBM Zapp document"] = 544,
    ["IBM zCodeFormatSettings"] = 545,
    ["IMG Catapult PSP"] = 550,
    ["IVMS101 by CODE Protocol"] = 1255,
    ["Infinispan Configuration"] = 552,
    ["Infinispan Server Configuration"] = 553,
    Infrahub = 554,
    Istanbul = 1198,
    ["JDownloader2 crawler multi-rules"] = 568,
    ["JDownloader2 crawler single-rules"] = 567,
    ["JFrog Applications Config"] = 569,
    ["JFrog File Spec"] = 570,
    ["JFrog Pipelines YML DSL"] = 1204,
    ["JMeter DSL cli config"] = 571,
    JReleaser = 574,
    ["JSON Document Transform"] = 582,
    ["JSON Feed"] = 583,
    ["JSON Resume"] = 860,
    ["JSON Schema Draft 2020-12"] = 1072,
    ["JSON Schema Draft 4"] = 1069,
    ["JSON Schema Draft 4 (unofficial with '$ref' and 'format')"] = 1237,
    ["JSON Schema Draft 7"] = 1070,
    ["JSON Schema Draft 7 (unofficial strict)"] = 1238,
    ["JSON Schema Draft 8 (2019-09)"] = 1071,
    ["JSON-API"] = 581,
    ["JSON-e templates"] = 1135,
    ["JSON-stat 2.0"] = 1065,
    JSONPatch = 585,
    ["JSR Package Config (jsr.json)"] = 575,
    Jarl = 1371,
    Jasmine = 562,
    Jekyll = 563,
    ["Jenkins X Pipelines"] = 564,
    ["Jenkins X Requirements"] = 565,
    Jest = 566,
    Jocker = 572,
    ["Jovo Language Models"] = 573,
    Jsontron = 586,
    ["Jujutsu (jj) VCS config"] = 1357,
    ["KIMMDY config file"] = 597,
    ["KODE/CI build.yaml"] = 1200,
    ["KSP-AVC"] = 1066,
    ["KSP-CKAN"] = 1067,
    ["KSP-NetKAN"] = 1068,
    KSY = 1267,
    KSail = 458,
    ["KYA Manifest"] = 1268,
    ["Karakum configuration file"] = 454,
    Kas = 589,
    ["Kestra flow file"] = 598,
    ["Keycloak REST API"] = 1207,
    ["Knative Functions - func.yaml"] = 455,
    Knip = 456,
    ["Knip JSONC"] = 457,
    ["Knowledge Unit"] = 606,
    ["Kometa (nightly) config file"] = 600,
    ["Kometa config file"] = 599,
    ["Kong DBLess config"] = 1201,
    KrakenD = 601,
    ["Kubri Configuration"] = 609,
    LOOBin = 627,
    ["Lake configuration file"] = 1360,
    ["Landing Zone Accelerator on AWS - Accounts Config"] = 318,
    ["Landing Zone Accelerator on AWS - Customizations Config"] = 319,
    ["Landing Zone Accelerator on AWS - Global Config"] = 320,
    ["Landing Zone Accelerator on AWS - IAM Config"] = 321,
    ["Landing Zone Accelerator on AWS - Network Config"] = 322,
    ["Landing Zone Accelerator on AWS - Organization Config"] = 323,
    ["Landing Zone Accelerator on AWS - Replacements Config"] = 324,
    ["Landing Zone Accelerator on AWS - Security Config"] = 325,
    ["Lando (landofile)"] = 127,
    ["LangGraph Platform configuration"] = 1279,
    ["Language configuration"] = 1278,
    Lefthook = 614,
    ["Liferay client-extension.yaml"] = 621,
    ["LinkML Metamodel"] = 623,
    ["LiquiLens Evidence Carrier Reference v1"] = 625,
    ["LiquiLens Evidence Carrier v1"] = 624,
    Liquibase = 1145,
    ["Liquibase Flow File"] = 1146,
    ["Lively Properties"] = 626,
    ["Lobe AI Agent"] = 129,
    Loki = 130,
    ["MLOS Config (*.mlos.jsonc, *.mlos.json5, *.mlos.json)"] = 670,
    ["MS2Rescore Configuration"] = 678,
    ["MSTest testconfig.json"] = 679,
    ["Madge configuration"] = 633,
    ["Madness (madness.yml)"] = 1218,
    ["Mado configuration"] = 634,
    ["Maestro Flow"] = 635,
    ["Mail Servers Configuration"] = 1392,
    ["MapEHR Mapping"] = 636,
    Markdownlint = 1149,
    ["Mason Registry"] = 1152,
    ["MegaLinter Custom Flavor"] = 639,
    ["MegaLinter configuration"] = 638,
    ["MegaLinter descriptor"] = 640,
    Melange = 1245,
    ["Meltano project definition"] = 641,
    ["Mergify Configuration"] = 680,
    ["Mermaid config"] = 2,
    ["Metadata for a Bazel module"] = 642,
    ["Metadata for a Cinnamon spice"] = 1296,
    ["Metatype Configuration"] = 643,
    ["MetricsHub Configuration"] = 644,
    ["MetricsHub Connector Configuration"] = 645,
    ["Micro Editor Syntax"] = 1228,
    ["Microsoft Band Web Tile"] = 646,
    ["Microsoft RulesEngine workflow rules"] = 1283,
    ["Microsoft RulesEngine workflow rules list"] = 1284,
    ["Minecraft Custom Main Menu Mod"] = 1246,
    ["Minecraft Data Pack Advancement"] = 648,
    ["Minecraft Data Pack Biome"] = 649,
    ["Minecraft Data Pack Configured Carver"] = 650,
    ["Minecraft Data Pack Damage Type"] = 651,
    ["Minecraft Data Pack Dimension"] = 653,
    ["Minecraft Data Pack Dimension Type"] = 652,
    ["Minecraft Data Pack Item Modifier"] = 654,
    ["Minecraft Data Pack Loot Table"] = 655,
    ["Minecraft Data Pack Metadata"] = 656,
    ["Minecraft Data Pack Predicate"] = 657,
    ["Minecraft Data Pack Recipe"] = 658,
    ["Minecraft Data Pack Tag"] = 659,
    ["Minecraft Data Pack Template Pool"] = 660,
    ["Minecraft Data Pack Trim Material"] = 665,
    ["Minecraft Data Pack Trim Pattern"] = 666,
    ["Minecraft Resource Pack Lang"] = 661,
    ["Minecraft Resource Pack Particle"] = 662,
    ["Minecraft Resource Pack Texture Mcmeta"] = 664,
    ["Minecraft Resourcepack Sounds"] = 663,
    ["MockServer Expectation"] = 672,
    ["MockServer Expectations"] = 673,
    ModuleAssembler = 668,
    ["Monade CLI Stack Configuration"] = 683,
    ["MongoDB Atlas Search Index Definition"] = 1199,
    ["Monika Configuration"] = 1197,
    ["Monoweave Configuration"] = 677,
    ["Motif config"] = 1088,
    MultiQC = 1337,
    ["NOX Framework (Service)"] = 705,
    ["Netin Diagnostic System Template"] = 1156,
    ["Netlify config"] = 686,
    ["Network-as-Code Data Model"] = 687,
    ["Next Gen UI Agent A2A Server Configuration"] = 688,
    ["Next Gen UI Agent Configuration"] = 690,
    ["Next Gen UI Agent MCP Server Configuration"] = 689,
    ["Nightwatch.js"] = 697,
    ["Nika workflow"] = 702,
    ["Node.js configuration"] = 1093,
    ["NueJS configuration file"] = 710,
    ["Nuitka Package Config"] = 1260,
    ["Nullstone config"] = 712,
    ["ODGS Data Rules"] = 719,
    ["ODGS Ontology Graph"] = 720,
    ["ODGS Standard Metrics"] = 718,
    ["OKF Graph"] = 1435,
    ["ONe's changelog entry"] = 734,
    ["ONe's service descriptor"] = 733,
    ["ORT Server repository environment configuration"] = 745,
    ["OSCAL Assessment Plan (AP)"] = 747,
    ["OSCAL Assessment Results (AR)"] = 748,
    ["OSCAL Catalog"] = 749,
    ["OSCAL Component Definition (CDef)"] = 750,
    ["OSCAL Plan of Action and Milestones (POA&M)"] = 751,
    ["OSCAL Profile"] = 752,
    ["OSCAL System Security Plan (SSP)"] = 753,
    ["OSS Review Toolkit configuration"] = 754,
    ["OSS Review Toolkit curation"] = 755,
    ["OSS Review Toolkit package configuration"] = 756,
    ["OSS Review Toolkit project package manager definition"] = 757,
    ["OSS Review Toolkit repository configuration"] = 758,
    ["OSS Review Toolkit resolutions"] = 759,
    ["October CMS columns"] = 716,
    ["October CMS fields"] = 717,
    ["Oh My Posh"] = 722,
    Okteto = 723,
    ["Ona Tasks and Services"] = 725,
    Opctl = 1091,
    ["Open Data Contract Standard (ODCS)"] = 738,
    ["Open Data Product Standard (ODPS)"] = 739,
    ["Open Know-How"] = 1342,
    ["Open Pentest Format"] = 740,
    OpenDecree = 1409,
    ["OpenDecree Configuration"] = 1410,
    ["OpenRewrite Resource"] = 736,
    OpenSRM = 741,
    OpenStatus = 1353,
    ["OpenTelemetry Declarative Configuration"] = 737,
    ["OpenUtau character yaml"] = 730,
    ["OpenUtau ustx"] = 731,
    ["OpenWeather Current Weather API"] = 1134,
    ["OpenWeather Road Risk API"] = 1133,
    ["Ory Hydra configuration"] = 541,
    ["Ory Keto configuration"] = 605,
    ["Ory Kratos configuration"] = 746,
    ["Ory Oathkeeper configuration"] = 714,
    ["Outblocks App configuration"] = 743,
    ["Outblocks database table"] = 744,
    ["Outblocks project configuration"] = 742,
    PDM = 767,
    POPxf = 779,
    ["POPxf Correlations"] = 780,
    ["PRML manifest"] = 787,
    Packer = 763,
    PactSpec = 764,
    Panache = 765,
    Pantsbuild = 1214,
    ["Paper paper-plugin.yml"] = 766,
    ["Pipeline component"] = 1147,
    ["Platform.sh application"] = 13,
    ["Platform.sh routes"] = 14,
    ["Platform.sh services"] = 15,
    ["Plex Prerolls"] = 777,
    ["PocketMine plugin.yml"] = 774,
    ["Podman Desktop Extension"] = 1429,
    ["Postman collection"] = 783,
    ["Power Pages Configuration"] = 1354,
    ['Preset list for a "ChrisTitusTech/winutil"'] = 1299,
    ["ProActions AI-Kit Configuration"] = 795,
    ["ProActions AI-Kit Configuration for Menus"] = 797,
    ["ProActions AI-Kit Configuration for Sections"] = 799,
    ["ProActions AI-Kit Configuration for Services"] = 796,
    ["ProActions AI-Kit Configuration for Steps"] = 800,
    ["ProActions AI-Kit Configuration for Templates"] = 798,
    ["Problem object RFC9457"] = 1243,
    ["Problem package format"] = 801,
    ["Problem package generators"] = 802,
    ["Problem package submissions"] = 803,
    ["Problem package test group metadata"] = 804,
    Pterodactyl = 1193,
    ["Pull Request Labeler"] = 821,
    Pulumi = 829,
    ["PyGTA Config"] = 825,
    PyProject = 830,
    Pylock = 1345,
    Pyright = 831,
    ["Python script metadata"] = 1339,
    ["QType AI DSL"] = 834,
    Qgoda = 833,
    ["Qlik Talend Cloud Pipeline - Data Model"] = 1421,
    ["Qlik Talend Cloud Pipeline - Dataset"] = 1419,
    ["Qlik Talend Cloud Pipeline - New Task Defaults"] = 1425,
    ["Qlik Talend Cloud Pipeline - Project"] = 1417,
    ["Qlik Talend Cloud Pipeline - Schedule"] = 1420,
    ["Qlik Talend Cloud Pipeline - Source Selection"] = 1422,
    ["Qlik Talend Cloud Pipeline - Task"] = 1418,
    ["Qlik Talend Cloud Pipeline - Transformation Data Flow"] = 1424,
    ["Qlik Talend Cloud Pipeline - Transformation Rules"] = 1423,
    Qodana = 1166,
    ["Qt Creator workspace file"] = 1276,
    ["Quali Torque Blueprint Spec 2"] = 1191,
    ["QueryFirst config file"] = 1210,
    ["QuikRun Configuration"] = 1426,
    ["Qwen Code Settings"] = 1406,
    ["RKE Cluster Configuration JSON"] = 1144,
    ["RKE Cluster Configuration YAML"] = 1143,
    RadioHound = 824,
    ["Raid Profile"] = 1407,
    ["Raid Repo Configuration"] = 1408,
    Railpack = 836,
    Railway = 835,
    ["Rancher Fleet"] = 826,
    ["Rattler-build"] = 837,
    Ray = 1105,
    ["Read the Docs"] = 828,
    ["Red-DiscordBot Cog"] = 844,
    ["Red-DiscordBot Cog Repo"] = 845,
    ["Red-DiscordBot Trivia"] = 846,
    ["Releasaurus Config"] = 10,
    ReleaseKit = 9,
    ["Render Blueprints"] = 1142,
    RenderCV = 864,
    Renovate = 861,
    ["Renovate global configuration"] = 862,
    ["Renovate inherited configuration"] = 863,
    ["Replit config"] = 852,
    Restate = 1332,
    ["Revel Digital Gadget Definition File"] = 1356,
    RoadRunner = 866,
    ["Robust Station Image"] = 1362,
    Rockcraft = 867,
    ["Roo Coder Custom Modes"] = 868,
    Rubocop = 857,
    ["Rudder techniques"] = 1250,
    Ruff = 858,
    ["Rust Project"] = 859,
    ["Rust toolchain"] = 873,
    ["SDMX data message"] = 900,
    ["SDMX metadata message"] = 899,
    ["SDMX structure message"] = 898,
    ["SIL Kit Participant Configuration"] = 911,
    ["SIL Kit Registry Configuration"] = 912,
    ["SPDX 2.3"] = 954,
    SWADL = 970,
    ["Safebox Config"] = 1205,
    ["Sapphire CLI Config"] = 876,
    ["SauceCTL Configuration"] = 1153,
    Scarb = 896,
    ["Schema Catalog"] = 891,
    ["Scoop manifest"] = 897,
    ["Secure SDLC Evidence Bundle"] = 901,
    ["Semantic Data Fabric (SDF) file"] = 902,
    ["Semgrep Rule"] = 904,
    ["Serenity Code Generator (Sergen)"] = 905,
    ["Serverless Framework Configuration"] = 1160,
    ["Serverless Workflow"] = 1162,
    ["Settings for a Cinnamon spice"] = 1295,
    ["Settings.paf"] = 907,
    ["Shopware 6 Configuration"] = 1163,
    ["Shopware CLI Extension Store Configuration"] = 1164,
    ["Shopware CLI Project Store Configuration"] = 1165,
    ["Sigma Detection Rule"] = 909,
    ["SigmaCV CV"] = 5,
    ["Sigrid scope configuration file"] = 910,
    ["SkyPilot Task JSON"] = 1251,
    ["Slack app manifest"] = 917,
    ["Slang Server Configuration"] = 1433,
    Snapcraft = 919,
    ["Solarxy project config"] = 922,
    Solidarity = 923,
    ["Solution filters"] = 924,
    ["Source Maps v3"] = 925,
    Sourcery = 926,
    ["Spack bootstrap.yaml"] = 927,
    ["Spack cdash.yaml"] = 928,
    ["Spack ci.yaml"] = 929,
    ["Spack compilers.yaml"] = 930,
    ["Spack concretizer.yaml"] = 931,
    ["Spack config.yaml"] = 932,
    ["Spack definitions.yaml"] = 933,
    ["Spack develop.yaml"] = 934,
    ["Spack env_vars.yaml"] = 935,
    ["Spack environment"] = 941,
    ["Spack include.yaml"] = 936,
    ["Spack mirrors.yaml"] = 937,
    ["Spack modules.yaml"] = 938,
    ["Spack packages.yaml"] = 939,
    ["Spack repos.yaml"] = 940,
    ["Spack toolchains.yaml"] = 942,
    ["Spack upstreams.yaml"] = 943,
    ["Spack view.yaml"] = 944,
    ["Speakeasy Generation Config File"] = 948,
    ["Speakeasy Lint Configuration File"] = 945,
    ["Speakeasy Test Generation Configuration File"] = 946,
    ["Speakeasy Workflow File"] = 947,
    SpecIF = 949,
    ["Specmatic Configuration"] = 950,
    ["Specpin spec file"] = 3,
    ["Sponge Mixin configuration"] = 951,
    ["Spotlight Ruleset"] = 952,
    StackBlitz = 958,
    ["StackHawk Scanner Configuration"] = 1159,
    Stale = 959,
    Starfish = 960,
    ["Starlake Data Pipeline"] = 1131,
    Starship = 961,
    ["Statamic Blueprint"] = 962,
    ["Stella configuration file"] = 963,
    ["Streamlit configuration file"] = 964,
    ["Stryker Mutator"] = 967,
    ["StyleCop Analyzers Configuration"] = 968,
    ["Stylelint (.stylelintrc)"] = 969,
    ["Stylua Config"] = 1346,
    ["Sublime Syntax"] = 1206,
    ["Subsquid squid manifest"] = 1253,
    ["Swagger API 2.0"] = 971,
    ["Symfony Routing Configuration"] = 972,
    ["Symfony Serializer Mapping"] = 973,
    ["Symfony Services Configuration"] = 974,
    ["Symfony Validation Mapping"] = 975,
    ["Synadia Connect Component"] = 976,
    TSON = 1014,
    TSTyche = 1015,
    ["TYPO3 Vendor Bundler config"] = 1021,
    ["Tab data for a LinUtil"] = 1302,
    ["Tab list for a LinUtil"] = 1301,
    Tach = 977,
    ["Tach Domain"] = 978,
    Talhelper = 980,
    ["Talisman configuration"] = 981,
    Taplo = 1347,
    ["Taskfile config"] = 1136,
    Taurus = 982,
    Tauticord = 983,
    ["Tekton Pipeline"] = 1375,
    ["Tekton PipelineRun"] = 1376,
    ["Tekton Task"] = 1373,
    ["Tekton TaskRun"] = 1374,
    Telefonistka = 1333,
    ["Terrateam config"] = 1359,
    ["TestEnvironment.json"] = 995,
    ["TextMate Grammar"] = 994,
    Threagile = 989,
    ["Tier.run pricing.json"] = 986,
    Tikibase = 987,
    Tombi = 992,
    ["Traefik v2"] = 998,
    ["Traefik v2 File Provider"] = 999,
    ["Traefik v3"] = 1000,
    ["Traefik v3 File Provider"] = 1001,
    ["Travis CI (.travis.yml)"] = 997,
    Treefmt = 517,
    Trident = 1329,
    Trivy = 1004,
    ["TrueScript for *.tscript files"] = 1005,
    ["Tugboat QA config.yml"] = 1326,
    TunnelHub = 1241,
    Turborepo = 996,
    Tycho = 1290,
    Tye = 1167,
    ["Tyk Gateway - Open Source v5.7+"] = 1338,
    ["UET BuildConfig.json"] = 1211,
    ["UI5 Manifest"] = 1027,
    ["UNCORS configuration"] = 1032,
    ["UTAM Page Object"] = 1030,
    ["Ubuntu Server Autoinstall"] = 1025,
    ["Unified Tenant Configuration Management (UTCM) Monitor"] = 1330,
    ["Uniswap Token List"] = 1116,
    ["Universal Schedule Format"] = 1033,
    ["Unreal Engine Uplugin"] = 1212,
    ["Unreal Engine Uproject"] = 1213,
    ["UpCloud CLI (upctl) configuration"] = 1331,
    ["Updatecli Compose"] = 1175,
    ["Updatecli Policy Manifest"] = 1176,
    ["Updatecli Policy Metadata"] = 1177,
    Uplift = 1209,
    ["Upsun config"] = 12,
    ["User Journey Map"] = 1141,
    V2Ray = 1181,
    ["VSCode Code Snippets"] = 301,
    ["VSIX CLI publishing"] = 1052,
    Vector = 1035,
    ["Vela Pipeline Configuration"] = 1038,
    Vercel = 300,
    ["Version Bumper config"] = 1041,
    Vespertide = 1380,
    ["Vespertide Migration"] = 1381,
    ["Vespertide Model"] = 1382,
    ["Viash Component Config"] = 1335,
    ["Viash Package Config"] = 1336,
    Visivo = 1239,
    Vogi = 1046,
    ["WP-CLI"] = 1062,
    Wake = 1328,
    ["Waku Config"] = 1305,
    ["Web App Manifest"] = 1058,
    ["Web types"] = 1061,
    WebExtensions = 1057,
    ["Webman package recipe"] = 1187,
    ["Windows Package Manager Installer Manifest"] = 1113,
    ["Windows Package Manager Locale Manifest"] = 1114,
    ["Windows Package Manager Singleton Manifest"] = 1112,
    ["WireMock CLI import configuration"] = 1311,
    ["WireMock CLI local service configuration"] = 1310,
    ["WireMock message stub mapping"] = 1309,
    ["WireMock stub mapping"] = 1308,
    ["Woodpecker pipeline config"] = 1155,
    ["Wrangler CLI"] = 1063,
    ["XenForo add-on manifest"] = 1064,
    ["Xstate Machine"] = 1173,
    ["Yandex Workflow Language"] = 1297,
    ["Yarn Config (.yarnrc.yml)"] = 1129,
    ["Yippee-Ki-JSON configuration YML"] = 1120,
    ["YouTrack App"] = 1294,
    ["Zarf Package Configuration"] = 1361,
    ["Zerops import file"] = 1282,
    ["Zola Configuration"] = 1372,
    abtop = 33,
    act3 = 1413,
    actionlint = 43,
    ["aerleon.yml"] = 27,
    ["amplify.yml"] = 20,
    ["amxx-builder manifest"] = 1428,
    ["angular.json"] = 48,
    apko = 1244,
    ["app-definition.yaml"] = 52,
    ["apple-app-site-association"] = 50,
    ["appsettings.StormPetrel.json"] = 57,
    ["appsettings.json"] = 55,
    ["appsscript.json"] = 54,
    ["appveyor.yml"] = 56,
    ["aqua-generate-registry.yaml"] = 59,
    ["aqua-policy.yaml"] = 60,
    ["aqua.yaml"] = 58,
    ["arazzo.json"] = 62,
    ["arb.json"] = 63,
    ["arc.json"] = 65,
    ["architect.yml"] = 64,
    ["artifacthub-repo.yml"] = 73,
    ["asm-lsp"] = 75,
    ["ast-grep rules"] = 78,
    ["ast-grep sgconfig.yml"] = 77,
    ["azure.yaml"] = 86,
    ["babelrc.json"] = 143,
    ["bamboo-spec"] = 147,
    basedpyright = 145,
    ["bashly-strings.yml"] = 1221,
    ["batect.yml"] = 146,
    ["beef-database-codegen"] = 148,
    ["beef-database-v5-codegen"] = 150,
    ["beef-entity-codegen"] = 149,
    ["beef-entity-v5-codegen"] = 151,
    ["behat.yml"] = 167,
    ["bigquery-table"] = 152,
    ["bioimageio resource description"] = 1261,
    ["bitbucket-pipelines"] = 154,
    bitrise = 155,
    ["bitrise-step"] = 156,
    ["block.json"] = 184,
    ["bottom configuration"] = 102,
    ["bower.json"] = 158,
    ["bozr.suite.json"] = 171,
    bpkg = 1222,
    ["browser.i18n.json"] = 172,
    ["browsh configuration"] = 173,
    bucklescript = 174,
    ["buf.gen.yaml"] = 105,
    ["buf.lock"] = 106,
    ["buf.plugin.yaml"] = 107,
    ...
    ["build-changelog"] = 175,
    ["bun.lock"] = 180,
    ["bundleconfig.json"] = 181,
    ["bunfig.toml"] = 182,
    ["cargo-mutants-config.yaml"] = 110,
    ["cargo-nextest repository configuration"] = 691,
    ["cargo-nextest user configuration"] = 692,
    ["ccmod.json"] = 1306,
    changelogging = 1273,
    ["chezmoi configuration"] = 200,
    ["chisel-slices.json"] = 327,
    ["chrome-extension-locales-messages.json"] = 308,
    ["chutzpah.json"] = 309,
    cibuildwheel = 205,
    ["clang-format (.clang-format)"] = 1179,
    ["clang-tidy"] = 282,
    clangd = 281,
    clib = 283,
    ["cloud-init: cloud-config userdata"] = 285,
    ["cloud-sdk-pipeline-configuration"] = 311,
    ["cloudbuild.json"] = 312,
    cloudify = 284,
    cmakefmt = 223,
    ["cmdx.yaml"] = 113,
    ...
    ["commands.json"] = 304,
    ["commit-check"] = 330,
    ["commitlint (.commitlintrc)"] = 1115,
    ["committed.toml"] = 331,
    ["compile_commands.json"] = 303,
    ["compilerconfig.json"] = 302,
    ["completely.yml"] = 1217,
    ["component-detection-manifest.json"] = 334,
    ["component.json"] = 333,
    ["composer.json"] = 332,
    ["conda-forge"] = 209,
    ["config.yaml"] = 827,
    ["contentmanifest.json"] = 310,
    ["contribute.json"] = 335,
    ["cosmos.config.json"] = 306,
    ["crowdin.yml"] = 336,
    crucible = 340,
    ["ctfd-setup configuration file"] = 1318,
    ["custom-elements.json"] = 1231,
    ["cypress.json"] = 341,
    ["dacier.yml"] = 1416,
    ["datalogic-scan2deploy-android"] = 352,
    ["datalogic-scan2deploy-ce"] = 353,
    ["dbt Dependencies"] = 241,
    ["dbt Packages"] = 243,
    ["dbt Project"] = 242,
    ["dbt Selectors"] = 244,
    ["dbt YAML files"] = 245,
    ...
    ["ddev-global"] = 354,
    ["ddev-project"] = 355,
    ["debugsettings.json"] = 356,
    ["dependabot-v2.json"] = 361,
    ["dependabot.json"] = 360,
    ["deployed-cli"] = 1172,
    devconcurrent = 258,
    ["devcontainer-feature.json"] = 293,
    ["devcontainer.json"] = 292,
    devinit = 1122,
    ["devspace.yaml"] = 1195,
    djlint = 1123,
    ["docker bake"] = 367,
    ["docker sequencer"] = 368,
    ["docker-compose.yml"] = 1121,
    ["dockerd.json"] = 365,
    ["dotnet Release Index manifest"] = 380,
    ["dotnet-tools.json"] = 381,
    ["dotnetcli.host.json"] = 382,
    ["dprint.json"] = 383,
    ["drone.json"] = 384,
    ["dss-2.0.0.json"] = 386,
    ["dstack configuration"] = 387,
    ["dtool dataset metadata"] = 1313,
    ["dvc.yaml"] = 389,
    ["ecosystem.json"] = 394,
    ["editorconfig-checker"] = 396,
    eksctl = 397,
    ["electron-builder configuration file"] = 423,
    ["epr-manifest.json"] = 422,
    ["estampo.toml"] = 421,
    ["evcc.yaml"] = 424,
    ["ezd task runner"] = 435,
    ["fabric.mod.json"] = 438,
    ["first-timers-bot"] = 446,
    ["flagd flag configuration"] = 138,
    ["fly.io Configuration"] = 139,
    fulibWorkflows = 1154,
    ["function.json"] = 459,
    ["gRPC API Gateway & OpenAPI Config"] = 22,
    ["gematik health care insurance list"] = 1324,
    ["gematik health care patient list"] = 1321,
    ["gematik health care provider institution list"] = 1323,
    ["gematik health care provider list"] = 1322,
    ["gematik tiger test environment configuration"] = 1325,
    ["gh-dash"] = 473,
    ["gha-doctor"] = 474,
    ["git-cliff"] = 470,
    ["git-town.toml"] = 1370,
    ["github-settings-as-code"] = 853,
    ["gitlab-ci"] = 488,
    ["global.json"] = 505,
    ["glslint config"] = 1,
    ["go-feature-flag Flag Configuration"] = 509,
    ["gojo.yaml"] = 510,
    gollama = 508,
    ["hassette.toml"] = 533,
    ["haxelib.json"] = 529,
    ...
    ["ide.host.json"] = 546,
    ["ifstate.yaml"] = 547,
    ["imageoptimizer.json"] = 548,
    ["importmap.json"] = 551,
    ["index.toml (packwiz)"] = 1430,
    instant_python_config = 555,
    instant_python_custom_project = 556,
    intlayer = 557,
    ["ioBroker Configuration"] = 558,
    ["ioBroker JSON UI"] = 559,
    ["ioBroker Package manifest"] = 560,
    ["ixpect.conf.yaml"] = 561,
    ["ize.toml"] = 1208,
    ["jsconfig.json"] = 587,
    ["jscpd Configuration"] = 1192,
    jsdoc = 1104,
    ["k3d.yaml"] = 588,
    ["k9s aliases.yaml"] = 590,
    ["k9s cluster-config.yaml"] = 592,
    ["k9s config.yaml"] = 591,
    ["k9s hotkeys.yaml"] = 593,
    ["k9s plugins.yaml"] = 594,
    ["k9s skin.yaml"] = 595,
    ["k9s views.yaml"] = 596,
    ["kind cluster"] = 610,
    ["kontinuous-config.yaml"] = 608,
    ["kontinuous-values.yaml"] = 607,
    ["kustomization.yaml"] = 611,
    ["label-commenter-config.yml"] = 612,
    ["latexindent configuration"] = 128,
    ["launchsettings.json"] = 613,
    lazydocker = 1230,
    lazygit = 1229,
    ["lego.json"] = 615,
    ["lerna.json"] = 616,
    ["lgtm.yml"] = 617,
    ["liblab.config.json"] = 618,
    ["libman.json"] = 619,
    ["license-report-config.json"] = 620,
    ["linkinator.config.json"] = 622,
    ["lint-staged (.lintstagedrc)"] = 1081,
    ["local.settings.json"] = 629,
    ["localazy.json"] = 630,
    ["lotus.yaml"] = 628,
    ["lsd colors"] = 132,
    ["lsd config"] = 131,
    ...
    lychee = 1080,
    ["macro.json"] = 1196,
    ["markdown-link-check"] = 1150,
    maturin = 1151,
    mboats = 1158,
    memnex = 1414,
    ["micro-settings.json"] = 1223,
    ["mimetypes.json"] = 647,
    ["mirrord config"] = 1084,
    ["misata.yaml"] = 1083,
    mise = 1085,
    ["mkdocs.yml"] = 667,
    ["mockd.yaml"] = 671,
    ["mod.pw.toml (packwiz)"] = 1431,
    ["modelparams.dev Model"] = 674,
    ["models CLI"] = 675,
    ["monospace.yml"] = 676,
    ["moon.yml"] = 1307,
    ["mprocs Configuration file"] = 1277,
    ["mrdocs.yml"] = 669,
    ["mta.yaml"] = 1086,
    ["mtad.yaml"] = 1087,
    ["mycode.json"] = 684,
    nFPM = 696,
    ["napari plugin manifest"] = 685,
    neoload = 1099,
    ["nest-cli"] = 699,
    ["nexus-rpc-gen"] = 1397,
    ["nf-core module environment.yml"] = 693,
    ["nf-core module meta.yml"] = 694,
    ["nf-core subworkflow meta.yml"] = 695,
    ["ninjs (News in JSON)"] = 698,
    ["nitro.json"] = 1098,
    ["nixd configuration"] = 1249,
    ["nlu.json"] = 700,
    ["nodemon.json"] = 703,
    ["noodl config"] = 1157,
    ["notebook.mod.json"] = 704,
    now = 1094,
    ["npm-badges"] = 707,
    ["nswag.json"] = 711,
    ntangle = 713,
    ["nuclei-template.yaml"] = 708,
    ["nuget-project.json"] = 709,
    ["ocelot.json"] = 715,
    ogen = 721,
    ["omnisharp.json"] = 724,
    openHAB = 1383,
    ...
    oxfmt = 1393,
    oxlint = 1394,
    ["pack.toml (packwiz)"] = 1432,
    ["package.json"] = 760,
    ["package.manifest"] = 762,
    ["package.yaml"] = 761,
    ["partial-black.json"] = 168,
    ["partial-fastapi.json"] = 169,
    ["partial-pixi.json"] = 772,
    ["partial-scheduled.json"] = 170,
    ["pattern.json"] = 770,
    ["petstore-v1.0"] = 1203,
    pgap_yaml_input_reader = 768,
    pgrls = 769,
    pgxgen = 1387,
    pitcms = 1390,
    ["pixi.toml"] = 771,
    ["plagiarize-me.yaml"] = 776,
    ["plagiarize.yaml"] = 775,
    ["pnpm Workspace (pnpm-workspace.yaml)"] = 1314,
    ["podbard.yaml"] = 778,
    ["portman.json"] = 781,
    ["prefect.toml"] = 790,
    ["prefect.yaml"] = 791,
    ...
    ["prettierrc.json"] = 793,
    ["prisma.yml"] = 794,
    ["project-1.0.0-beta3.json"] = 806,
    ["project-1.0.0-beta4.json"] = 807,
    ["project-1.0.0-beta5.json"] = 808,
    ["project-1.0.0-beta6.json"] = 809,
    ["project-1.0.0-beta8.json"] = 810,
    ["project-1.0.0-rc1.json"] = 811,
    ["project-1.0.0-rc2.json"] = 812,
    ["project.json"] = 805,
    ["project.owasp.yaml"] = 813,
    ["prometheus-alertmanager.json"] = 817,
    ["prometheus.json"] = 814,
    ["prometheus.rules.json"] = 815,
    ["prometheus.rules.test.json"] = 816,
    ["proxies.json"] = 818,
    ["publiccode.yml"] = 819,
    ["pubspec.yaml"] = 820,
    ["pyrseas-0.8.json"] = 823,
    pytest = 832,
    ["quilt.mod.json"] = 1224,
    ["rc3 auth"] = 838,
    ["rc3 collection"] = 839,
    ...
    ["rc3 settings"] = 843,
    ["registry.yaml"] = 61,
    ["release drafter"] = 1100,
    ["release-hub.json"] = 8,
    ["release-please-config.json"] = 848,
    ["release-please-manifest.json"] = 849,
    ["release-plz.toml"] = 850,
    ["renv.lock"] = 865,
    ["reposets Configuration"] = 854,
    ["reposets Credentials"] = 855,
    ["revola.json"] = 6,
    ["rivet.json"] = 1248,
    ["rivet.yaml (legacy)"] = 1247,
    rumdl = 870,
    runny = 869,
    runspec = 1415,
    rustfmt = 871,
    ...
    samt = 874,
    samtrc = 875,
    ["sarif-1.0.0.json"] = 877,
    ["sarif-2.0.0.json"] = 878,
    ["sarif-2.1.0"] = 888,
    ["sarif-2.1.0-rtm.2"] = 879,
    ["sarif-2.1.0-rtm.3"] = 881,
    ["sarif-2.1.0-rtm.4"] = 883,
    ["sarif-2.1.0-rtm.5"] = 885,
    ["sarif-2.1.0-rtm.6"] = 886,
    ["sarif-external-property-file-2.1.0"] = 889,
    ["sarif-external-property-file-2.1.0-rtm.2"] = 880,
    ["sarif-external-property-file-2.1.0-rtm.3"] = 882,
    ["sarif-external-property-file-2.1.0-rtm.4"] = 884,
    ["sarif-external-property-file-2.1.0-rtm.5"] = 887,
    ["scalingo.json configuration"] = 890,
    ["schema.org - Action"] = 892,
    ["schema.org - ContactPoint"] = 893,
    ["schema.org - Place"] = 894,
    ["schema.org - Thing"] = 895,
    ["secrethub.yml"] = 1226,
    ["semantic-release"] = 903,
    servercn = 1439,
    ["servicehub.config.json"] = 1075,
    ["servicehub.service.json"] = 1074,
    ["settings.job"] = 906,
    ["sfdx-hardis configuration"] = 908,
    ["shard.yml"] = 1264,
    ["size-limit configuration"] = 913,
    ["skaffold.yaml"] = 1148,
    ["skill-map plugin extension manifest"] = 914,
    ["skill-map project settings"] = 915,
    ["skill-map provider kind"] = 916,
    ["skyuxconfig.json"] = 918,
    ["snowflake-config"] = 920,
    ["snowflake-connections"] = 921,
    ["spicepod.yaml"] = 1285,
    ["sqlc configuration"] = 955,
    ["stripe-app-local.json"] = 966,
    ["stripe-app.json"] = 965,
    swcrc = 1132,
    ["task.json"] = 979,
    taskcat = 1095,
    ["template.json"] = 984,
    ["templatsources.json"] = 985,
    ["text2confl config"] = 1395,
    ["theme.json"] = 988,
    ["tizen_workspace.json"] = 990,
    tldr = 991,
    ["tm_devices configuration file"] = 1352,
    tmuxinator = 1078,
    tox = 993,
    ["transcend.yml"] = 1002,
    ["tree-sitter grammar.json"] = 516,
    ["trime.yaml"] = 1003,
    ["trunk.yaml"] = 1006,
    ["ts-force-config.json"] = 1012,
    tsbuild = 1007,
    ["tsconfig.json"] = 1008,
    ["tsd.json"] = 1009,
    ["tsdoc.json"] = 1010,
    ...
    v8r = 1056,
    vcluster = 1271,
    ["vcpkg configuration file"] = 299,
    ["vcpkg manifest file"] = 298,
    ["vega-lite.json"] = 1037,
    ["vega.json"] = 1036,
    ["venvironment.yaml"] = 1039,
    ["venvplus.yaml"] = 1040,
    version = 1334,
    ["version.json"] = 1042,
    ["vhwdebugger-binding.yaml"] = 1044,
    ["vim-addon-info"] = 1045,
    ["vs-2017.3.host.json"] = 1048,
    ["vs-nesting.json"] = 1049,
    ["vsls.json"] = 1047,
    ["vss-extension.json"] = 1053,
    vtcfg = 1340,
    ["vtesttree.yaml"] = 1054,
    ["vtestunit.yaml"] = 1055,
    ["warp-keysets.json"] = 1232,
    ["warp-themes.json"] = 1233,
    ["warp-workflows.json"] = 1234,
    ["webhint.io"] = 1188,
    ["webjobpublishsettings.json"] = 1060,
    ["webjobs-list.json"] = 1059,
    ["well-known-fursona"] = 1272,
    ["xs-app.json"] = 1090,
    ["xunit.runner.json"] = 1073,
    ["yaml-workflow"] = 1438,
    yamlfmt = 1117,
    yamllint = 1118,
    ["yap.json"] = 1119,
  ...
  schemas = { {
      ...
      fileMatch = { "chezmoi.json", "chezmoi.jsonc", "chezmoi.toml", "chezmoi.yaml", "chezmoi.yml" },
      ...
      fileMatch = { "**/.crucible/config.json", "**/.crucible/config.local.json" },
      name = "crucible",
      ...
      fileMatch = { "*.saga-fragment.yaml", "*.saga-fragment.yml", ".saga-fragment.yaml", ".saga-fragment.yml" },
      ...
      fileMatch = { ".gha-doctor.yml", ".gha-doctor.yaml", "**/.github/gha-doctor.yml", "**/.github/gha-doctor.yaml" },
      name = "gha-doctor",
      ...
      fileMatch = { "liquilens-evidence-carrier.json", "*.liquilens-evidence-carrier.json" },
      ...
      fileMatch = { "liquilens-evidence-carrier-reference.json", "*.liquilens-evidence-carrier-reference.json" },
      ...
      fileMatch = { "**/.ona/config.yaml", "**/.ona/config.yml", "**/.ona/automations.yaml", "**/.ona/automations.yml", "**/.gitpod/automations.yaml", "**/.gitpod/automations.yml" },
      ...
      fileMatch = { "**/.skill-map/plugins/*/providers/*/extension.json", "**/.skill-map/plugins/*/extractors/*/extension.json", "**/.skill-map/plugins/*/analyzers/*/extension.json", "**/.skill-map/plugins/*/actions/*/extension.json", "**/.skill-map/plugins/*/formatters/*/extension.json", "**/.skill-map/plugins/*/hooks/*/extension.json" },
      ...
      fileMatch = { "**/.skill-map/settings.json", "**/.skill-map/settings.local.json" },
